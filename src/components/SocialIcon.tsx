...
export const WhatsAppIcon = () => {
  return (
    <SocialIcon
      href="https://wa.me/11981071231" // Substitua pelo seu número
      icon={
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
...
export const InstagramIcon = () => {
  return (
    <SocialIcon
      href="https://instagram.com/seuusuario" // Substitua pelo seu usuário
      icon={
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
...
export const SocialIcons = () => {
  return (
    <div className="fixed md:bottom-8 md:right-8 bottom-5 right-5 z-50 flex flex-col space-y-4">
      <GitHubIcon />
      <LinkedInIcon />
      <WhatsAppIcon />
    </div>
